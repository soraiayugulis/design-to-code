...
class GitHubCliAdapterTest {
    ...
    @Test
    fun shouldHandleCommitWithNoChanges() {
        // Given
        val gitHubCliAdapter = GitHubCliAdapter(tempDir)
        val message = "feat: test commit"

        // When
        val result = gitHubCliAdapter.commitChanges(message)

        // Then
        // May fail if no changes to commit, but should not throw
        assertTrue(result.success || result.errorMessage != null)
    }
    ...
    fun shouldHandleBranchNameWithoutFeaturePrefix() {
        ...
        // Then
        assertFalse(result.success, "Branch without feature/ prefix should be rejected")
    }
    ...
    fun shouldHandleBranchNameTooShort() {
        ...
        // Then
        // May fail validation or git execution
        assertTrue(result.success == false || result.errorMessage != null)
    }
}
